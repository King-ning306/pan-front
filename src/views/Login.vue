<template>
  <div class="login-body">
    ...
    <div class="login-panel">
      <el-form class="login-register" :model="formData" :rules="rules" ref="formDataRef" @submit.prevent>
        ...
        <el-form-item prop="email">
          <el-input clearable placeholder="请输入邮箱" size="large" v-model.trim="formData.email" maxLenth="150">
            <template #prefix>
        ...
        <div v-if="opType == 0 || opType == 2">
          ...
          <el-form-item prop="registerPassword">
            ...
            <el-input size="large" placeholder="请输入密码" v-model="formData.registerPassword" maxLength="150"
              show-password>
              <template #prefix>
                <span class="iconfont icon-password"></span>
              </template>
          ...
          <el-form-item prop="reRegisterPassword">
            ...
            <el-input size="large" placeholder="请确认密码" v-model="formData.reRegisterPassword" maxLength="150"
              show-password>
              <template #prefix>
                <span class="iconfont icon-password"></span>
              </template>
        ...
        <el-form-item prop="checkCode">
          <div class="check-code-panel">
            ...
            <el-input size="large" placeholder="请输入验证码" v-model="formData.checkCode" maxLength="10" @keyup.enter="doSubmit">
              <template #prefix>
                <span class="iconfont icon-checkCode"></span>
              </template>
            </el-input>
    ...
    <Dialog :show="dialogConfig4SendMailCode.show" :title="dialogConfig4SendMailCode.title"
      ...
      <el-form :model="formData4SendMailCode" :rules="rules" ref="formData4SendMailCodeRef" @submit.prevent>
        ...
        <el-form-item prop="checkCode" label="验证码">
          <div class="check-code-panel">
            ...
            <el-input size="large" placeholder="请输入验证码" v-model="formData4SendMailCode.checkCode" maxLength="10">
              <template #prefix>
                <span class="iconfont icon-checkCode"></span>
              </template>
            </el-input>
...
reRegisterPassword:[{required:true,message:"请输入密码"},{validator:checkRePassword,message:"两次输入的密码不一致"}],
